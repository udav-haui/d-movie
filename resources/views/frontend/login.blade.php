...
@section('content')
            ...
            <ul class="nav nav-tabs text-uppercase tab-information" role="tablist">
                <li role="presentation" class="text-center w-50 @if ($action === 'login') active @endif">
                    <a href="#login"class="font-16" aria-controls="login" role="tab" data-toggle="tab" aria-expanded="true">
                        ...
                        <span class="hidden-xs"><i class="fas fa-sign-in-alt"></i> {{__('Login')}}</span>
                    </a>
                </li>
                <li role="presentation" class="text-center w-50 @if ($action === 'register') active @endif">
                    <a href="#register"class="font-16" aria-controls="register" role="tab" data-toggle="tab" aria-expanded="false">
                        ...
                        <span class="hidden-xs"><i class="fas fa-key"></i> {{ __('Register') }}</span>
                    </a>
                </li>
            </ul>
            <!-- Tab panes -->
                    ...
                    <form action="{{ route('frontend.doLogin') }}" method="post">
                        ...
                        <div class="form-group">
                            <div class="col-md-16 text-center display-flex">
                                <div class="form-group">
                                    <a class="btn btn-2 btn-mua-ve"><i class="fab fa-facebook-f"></i> {{ __('Login with Facebook') }}</a>
                                </div>
                                <div class="form-group w-50">
                                    <a href="#" class="btn btn-3 btn-mua-ve"><i class="fab fa-google"></i> {{ __('Login with Google') }}</a>
                                </div>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                ...
                <div role="tabpanel" class="tab-pane fade @if ($action === 'register') in active @endif" id="register">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-16 margin-bottom-10">
                            ...
                            <input type="text" style="height: 30px;" name="name" id="name" class="form-control" placeholder="{{ __('Full Name') }}">
                        </div>
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-16 margin-bottom-10">
                            <label class="control-label font-16" for="register_email"><span style="color: red;">*</span>&nbsp;{{ __('Email') }}</label>
                            <div class="input-icon">
                                <i class="fa fa-envelope"></i>
                                <input type="text" style="height: 30px;" name="email" id="register_email" class="form-control" placeholder="{{ __('E-Mail') }}">
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-16 margin-bottom-10">
                            ...
                            <div class="input-icon">
                                ...
                                <select id="gender" style="height: 30px;" name="gender" class="form-control" data-placeholder="{{ __('Gender') }}" tabindex="1">
                                    <option class="option-item" value="-1">Giới tính</option>
                                    <option class="option-item" value="0">Nam</option>
                                    <option class="option-item" value="1">Nữ</option>
                                    <option class="option-item" value="2">Khác</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-16 margin-bottom-10">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" style="height: 30px;" id="phone" name="phone" class="form-control" placeholder="{{ __('Phone') }}">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-16 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-3 btn-mua-ve">
                                    {{ __('Register') }}</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-16 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-2 btn-mua-ve">
                                    <i class="fab fa-facebook-f"></i> {{ __('Continue with :name', ['name' => 'Facebook']) }}</button>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="form-group">
                        <div class="col-md-16 text-center">
                            <div class="form-group">
                                <button type="button" class="btn btn-3 btn-mua-ve">
                                    <i class="fab fa-google"></i> {{ __('Continue with :name', ['name' => 'Google']) }}</button>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
    ...
    <form method="post" action="{{ route('frontend.doLogin') }}">
        @csrf
