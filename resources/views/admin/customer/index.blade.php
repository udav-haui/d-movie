...
@section('app.title'){{ __('Customers Manage') }}
@endsection
@section('app.description'){{ __('Customers Manage') }}
@endsection
@section('titlebar.breadcrumb')
    <li><a href="/admin">{{ __('Dashboard') }}</a></li>
    <li class="active">{{ __('Customers Manage') }}</li>
@endsection
...
<script>
    ...
    let columnDefs = [],
        ...
        colOrder = [[0, 'desc']];
    @cannot('canEditDelete', \App\Customer::class)
        aoColumns.push({
            data: 'task',
            sortable: false,
            orderable: false
...
<script src="{{ asset('adminhtml/js/customer/index.js') }}"></script>
@endsection
...
@section('content')
    ...
    @can('canEditDelete', \App\Customer::class)
            ...
            <div class="col-md-1">
                <div class="btn-group">
                    ...
                    <ul role="menu" class="dropdown-menu border-radius-0 dmovie-border">
                        @if (!auth()->user()->can('delete', \App\Customer::class) && !auth()->user()->can('update',
                        \App\Customer::class))
    ...
    <div class="row">
        ...
        <div class="col-md-12 table-responsive">
            <table id="customers_ajax_dt" class="display nowrap dmovie-table"
                   cellspacing="0"
                   width="100%">
                <thead>
                    <tr>
