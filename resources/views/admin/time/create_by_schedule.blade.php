...
@section('app.title')
    {{ __('New showtime for :filmName', ['filmName' => $schedule->getFilm()->getTitle()]) }}
@endsection

@section('app.description'){{ __('New showtime for :filmName', ['filmName' => $schedule->getFilm()->getTitle()]) }}
@endsection
...
@section('titlebar.breadcrumb')
    ...
    <li class="active">{{ __('New Showtime') }}</li>
@endsection

@section('titlebar.title')
    {!! __('New showtime for <code>:filmName</code>', ['filmName' => $schedule->getFilm()->getTitle()]) !!}
@endsection
