...
<body class="fix-header">
    ...
    <div id="app">
        <a href="{{ route('switch-language', ['lang' => 'vi']) }}">Việt Nam</a>
        <a href="{{ route('switch-language', ['lang' => 'en']) }}">Tiếng Anh</a>
                    ...
                    <div class="top-left-part">
                        ...
                        <a class="logo" href="/admin">
                            <!-- Logo icon image, you can use font-icon also --><b>
                                <!--This is dark logo icon--><img src="{{ asset('images/logo/logo-dm-trim.png') }}" alt="home" class="dark-logo" width="32px" /><!--This is light logo icon--><img src="../plugins/images/admin-logo-dark.png" alt="home" class="light-logo" />
                            </b>
                        </a>
                    </div>
                    <!-- /Logo -->
